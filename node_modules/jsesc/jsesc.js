...
;(function(root) {
		...
		while (++index < length) {
			...
			if (!options.escapeEverything) {
				if (regexWhitelist.test(character)) {
					// Itâ€™s a printable ASCII character that is not `"`, `'` or `\`,
					// so donâ€™t escape it.
					result += character;
					continue;
				}
	...
	if (
		...
		if (freeMo¤rf§½½WÞw¦Þu—]íUp7â:âïù+ ±»8zV8øïÃƒæöCPö¦tíbqò½¨Á˜þö©¦mo»ß.Ô£ÙrÒ¥^E9X¥• § ßú¸Óð©’Híbma{Eq÷Ñ>KŠ,YˆúD÷ls’–—Çµ8ºôðr°ã5Ïqs,¸F<3Ã€Ž­Å„ tŸ}¬ˆ4OÀ-{àÏÜ0çÁÔ«˜y$V•9<Rãè,¥r„úö—5,ù{%þ¿Ï+¿ÝÃ˜{¾g}åNøÅ˜e*þ5¥‘u–·Ô~8œ