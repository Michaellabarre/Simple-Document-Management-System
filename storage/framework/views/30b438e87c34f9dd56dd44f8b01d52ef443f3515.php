...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0">
	<title>Payroll <?php echo $__env->yieldContent('title'); ?></title>
  <link rel="stylesheet" type="text/css" href="<?php echo e(asset('/dist/flatpickr.min.css')); ?>">
  ...
  <script type="text/javascript" src="<?php echo e(asset('/dist/flatpickr.min.js')); ?>"></script>
	<style type="text/css">
    .ui.footer.segment {
      margin: 5em 0em 0em;
      padding: 5em 0em;
