...
<?php $__env->startSection('content'); ?>
	<div class="ui segment">
		<form action="<?php echo e(route('otherincomecode.store')); ?>" class="ui form" method="post">
			<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
			<div class="field">
				<label>Other Income Code</label>
				<div class="field">
					<input type="text" name="payrolltype" placeholder="Enter the Other Income Code" value="<?php echo e(old('payroll')); ?>">
				</div>
			</div>
			<div class="field">
				<label>Status</label>
