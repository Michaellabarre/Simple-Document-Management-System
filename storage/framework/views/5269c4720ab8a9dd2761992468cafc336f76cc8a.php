...
<?php $__env->startSection('content'); ?>
	<div class="ui segment">
		<form action="<?php echo e(route('otherincomecode.update', [$data['id']])); ?>" class="ui form" method="post">
			<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
			<input type="hidden" name="_method" value="PUT">
			<div class="field">
				<label>Other Income Code</label>
				<div class="field">
					<input type="text" name="payrolltype" placeholder="Enter the Other Income Code" value="<?php echo e($data['payrolltype']); ?>">
				</div>
			</div>
			<div class="field">
				<label>Status</label>
			...
			<a href="<?php echo e(url('managelibraries/otherincomecode')); ?>" class="ui mini basic black button">Cancel</a>
	 	</form>
 	</div>
<?php $__env->stopSection(); ?>
