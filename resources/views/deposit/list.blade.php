	...
	<div class="ui grid">
		  <div class="four column row">
		    ...
		    <div class="right floated column">
		    	<a class="ui mini basic black  right floated button" href="{{ route('deposit.create') }}">
				<i class="icon add"></i>
					Add Deposit
				</a>
		    </div>
	...
	<div class="ui segment">
		<div class="ui styled fluid accordion">
			<div class="title">
		  	...
		  	<div class="content">
				<form  class="ui mini form" action="{{ url('deposit.search') }}" method="get">
					...
					<a href="{{ url('deposit') }}" class="ui mini basic black button">Clear</a>
				</form>
			</div>
		</div>
		<table class="ui  table">
			...
			<tbody>
				...
				@endif
					...
					<td>
						{{ date('M-d-Y', strtotime($deposit->deposit_date))  }}
					</td>
					<td>
						{{ $deposit->net_amount }}
					</td>
